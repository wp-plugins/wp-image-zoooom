    ...
    <div class="panel main_container">
        ...
        <div class="metabox-holder"> 
            ...
            <ul>
                ...
                <li><span class="dashicons dashicons-yes"></span>You can choose the zoom window position (left or right from the image)</li>
                <li><span class="dashicons dashicons-yes"></span>Works with Portfolio image</li>
                <li><span class="dashicons dashicons-yes"></span>Works with Easy Digital Downloads featured images</li>
                <li><span class="dashicons dashicons-yes"></span>Custom Theme Support</li>
            </ul>
            <a href="http://www.silkypress.com/" target="_blank" class="button-primary" rel="noreferrer">WP Image Zoooom Pro</a>
        </div> 
    </div>   
